...
Our support team uses Onyx to quickly find answers to customer questions. When someone asks about privacy features or self-hosting requirements, Onyx can pull from our documentation, past support tickets, and engineering notes to provide accurate, comprehensive answers in seconds.
