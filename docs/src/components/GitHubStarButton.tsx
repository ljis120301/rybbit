  ...
  return (
    <div className="mb-6 md:mb-8" onClick={() => trackAdEvent("github")}>
      <a
        ...
        className="inline-flex items-center gap-1 bg-neutral-200/80 dark:bg-neutral-800/70 hover:bg-neutral-300/80 dark:hover:bg-neutral-700/70 border border-neutral-400/70 dark:border-neutral-600/70 hover:border-neutral-500/80 dark:hover:border-neutral-700/80 text-neutral-900 dark:text-white px-3 py-1.5 rounded-full text-xs font-semibold transition-all duration-300 hover:-translate-y-1 shadow-xl shadow-neutral-400/50 dark:shadow-neutral-900/50 hover:shadow-2xl hover:shadow-neutral-500/60 dark:hover:shadow-neutral-800/60 backdrop-blur-sm ring-1 ring-neutral-900/10 dark:ring-white/10 hover:ring-neutral-900/20 dark:hover:ring-white/20"
      >
